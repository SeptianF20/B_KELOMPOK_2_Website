     ...
     <section id="faq" class="faq">
      <div class="container">
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-7">
            <p>
              Teknisi dengan standar pelatihan khusus untuk memastikan pekerjaan terselesaikan dengan sempurna.
            </p>
          </div>
        </div><!-- End F.A.Q Item-->
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="contact-about">
              <h3>YooVis</h3>
              <p>Yoovis adalah penyedia jasa servis dan sparepart untuk barang elektronik seperti Laptop, Printer dan HandPhone. 
              Kami memiliki pelayanan Home Delivery Service. 
              Untuk anda yang sibuk dan tak sempat pergi ke home service kami, 
              cukup melakukan booking untuk memesan jasa perbaikan maupun Sparepart melalui website atau aplikasi mobile pada smartphone anda, 
