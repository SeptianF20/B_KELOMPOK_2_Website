    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                ...
                <img src="<?php echo e(asset('frontend/assets/img/logo.png')); ?>" class="img-contact">
                </div>
            </div>
        </div>
        </div>
...
<script src="<?php echo e(asset('frontend/assets/vendor/purecounter/purecounter.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\E41191224_Ferry Septian Ferdiyanto\B_KELOMPOK_2_Website\YOOVIS\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>